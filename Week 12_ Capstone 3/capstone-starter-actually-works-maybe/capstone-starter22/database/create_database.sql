-- ---------------------------------------------------------------------- 
-- Target DBMS:           Azure SQL (SQL Server)
...
VALUES  
    ('Smartphone', 499.99, 1, 'A powerful and feature-rich smartphone for all your communication needs.', 'smartphone.jpg', 50, 0, 'Black'),
...
-- Insert Duplicate Products (Sample Duplicates from "bug")
INSERT INTO products (name, price, category_id, description, image_url, stock, featured, color)
VALUES  
    ('Laptop', 999.99, 1, 'A high-performance laptop for work and entertainment.', 'laptop.jpg', 30, 0, 'Gray'),
